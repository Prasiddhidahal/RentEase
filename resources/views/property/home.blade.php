        ...
        1000:{
            items:3
                   ...
                   $cityName = auth()->user()->city;
                       $province = App\Models\City::where('city_name', auth()->user()->city)->first();
                       $nearby =  App\Models\Property_detail::where('province', $province->province)->paginate(6);
                   @endphp
                   @if ($nearby)
                   <section class="section-property section-t8">
                    <div class="container">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="title-wrap d-flex justify-content-between">
                            <div class="title-box">
                              <h2 class="title-a">Nearby Properties</h2>
                            </div>
                            <div class="title-link">
                              <a href="/allproperty">All Property
                                <span class="ion-ios-arrow-forward"></span>
                  ...
                  @unless(count($nearby)==0)

                  @foreach($nearby as $near)

                    <div class="carousel-item-b">

                        <x-property_detail_card :property_detail="$near"/>
