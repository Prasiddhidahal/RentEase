        ...
        <div class="">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; width:1200px">
            <div class="card-body p-4 p-md-5">
              ...
              <form method="POST" action="/property/{{$property_detail->id}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                {{-- type of sale --}}
...
@endforeach
  ...
  input[type="checkbox"]:checked + #label {
    ...
    color: white;
                ...
                <h7 style="color:#2eca6a">Please enter if u are going to update location then only </h7>
                <br>
