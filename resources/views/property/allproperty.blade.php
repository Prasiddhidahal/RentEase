...
<body>
  ...
  <section class="property-grid grid">
    <div class="container">
          ...
          <div class="grid-option">
            <form>
              <select class="custom-select" onchange="sort_by()" name="category" id="category">
                ...
                <option value="4"  {{ $sort_txt == "4" ? 'selected' : '' }}>Agriculture </option>
                <option value="5"  {{ $sort_txt == "5" ? 'selected' : '' }}>Residential</option>
                <option value="6"  {{ $sort_txt == "6" ? 'selected' : '' }}>House</option>
                <option value="7"  {{ $sort_txt == "7" ? 'selected' : '' }}>Land</option>
                <option value="8"  {{ $sort_txt == "8" ? 'selected' : '' }}>Flat </option>
                <option value="9"  {{ $sort_txt == "9" ? 'selected' : '' }}>Apartment</option>
                <option value="10"  {{ $sort_txt == "10" ? 'selected' : '' }}>Hostel</option>
                <option value="11"  {{ $sort_txt == "11" ? 'selected' : '' }}>Price low to high</option>
                <option value="12"  {{ $sort_txt == "12" ? 'selected' : '' }}>Price high to low</option>
              </select>
              </select>
              {{-- {{$sort_txt}} --}}
            </form>
            ...
            <x-all_property_card :property_detail="$property_detail"/>
          </div>
      </div>
              @endforeach
            </div>
      ...
      {{-- {!!$property_details->withQueryString()->links('pagination::bootstrap-5')!!} --}}
...
<style>
  ...
  .page-link.page-link:first-child {
        margin-left: 5px;
    }
          ...
          <div class="widget-a">
            ...
            <div class="w-footer-a">
              <ul class="list-unstyled">
                <li class="color-a">
                  <span class="color-text-a">Email .</span> BrokerFree@gmail.com</li>
                <li class="color-a">
