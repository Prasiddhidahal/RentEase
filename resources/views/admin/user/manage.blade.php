        ...
        <table >
            ...
            <tbody>
                ...
                <tr class="table_row">
                    ...
                    <td  >
                        <a  class="detail" href="/admin/{{$user->id}}/edit" ><button class="edit"><i class='bx bx-edit'></i>Edit</button></a> 
                        @if ($user->status==1)
                            
                       
                        <a  class="detail" href="/admin/block/{{$user->id}}/{{2}}" ><button class="block"><i class='bx bx-block'></i>Block</button></a> 
                       
                           
                       @else
                        <a  class="detail" href="/admin/block/{{$user->id}}/{{1}}" ><button class="unblock"><i class='bx bx-check'></i>UnBlock</button></a> 
                        ...
                        <form method="POST" action="/admin/delete/{{$user->id}}">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="delete"><i class='bx bx-trash'></i>DELETE</button>
                        </form>
